...
const IndexPage = () => (
  <>
    <div>
      ...
      >
        Blitz + React 全栈开发手册，构建下一代 React 全栈应用
      </p>
      <div
        style={{
          display: 'flex',
    ...
    <div className="cards">
      ...
      <div>
        <h2>内容丰富</h2>
        <ul>
          <li>从多方位建设 <code>Blitz.js</code> 生态。</li>
          <li>
            内容包括但不局限于 <code>Blitz.js</code> <code>React</code> <code>FullStack</code> 等众多技术要点。
          </li>
    ...
    <h2>推荐你的 Blitz.js 文章？快来一起建设吧</h2>
    <pre
      style={{
        fontSize: '1rem'
      }}
